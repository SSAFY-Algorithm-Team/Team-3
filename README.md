...
5주차부터 SQL을 본격적으로 시작합니다. (**6·7주차는 알고리즘에 집중하기 위해, 8주차는 공기업 기출 세트로 쉽니다** — 아래 표의 매핑을 세 주씩 밀었습니다.)
...
|    —     |  **8주차**  | **쉬는 주 — 공기업 기출 세트 (SQL 1문제 포함)** |    —    | —        |
|    2     |    9주차    | 집계 함수                                       |   13    | Lv1~3    |
|    3     |   10주차    | NULL 처리 + GROUP BY 입문                       |   14    | Lv1~3    |
|    4     |   11주차    | GROUP BY 심화 + CASE                            |   12    | Lv2~4    |
|    5     |   12주차    | 문자열 · 날짜                                   |   14    | Lv1~3    |
|    6     |   13주차    | JOIN 기본                                       |   11    | Lv2~4    |
|    7     |   14주차    | 서브쿼리 + JOIN 심화                            |   12    | Lv2~5    |
|    8     |   15주차    | 종합 · 고난도                                   |   12    | Lv2~5    |
...
<details open>
<summary><h2>8주차 — 공기업 기출 (알고리즘 4 + SQL 1문제)</h2></summary>

**출처:** 2026 하반기 공기업 코딩테스트 기출 복원

7주차로 SWEA 커리큘럼을 마쳤으니, 이번 주는 **실제 공기업 코딩테스트에 나온 문제**를 풉니다.
문제 수는 적지만 **시험처럼 푸는 게 목표**입니다. 문제당 시간을 재고, PR에 소요 시간을 적어주세요.

> 🔒 **출처 기관은 공개하지 않습니다.** 문제 복원본이라 기관명을 README · PR · 커밋 메시지 · 파일명 어디에도 적지 마세요.
...
git switch main
git pull
git switch -c {깃허브 닉네임}/week-08
# 문제 풀고 커밋
git push -u origin {깃허브 닉네임}/week-08
