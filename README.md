...
5주차부터 SQL을 본격적으로 시작합니다. (**6·7주차는 알고리즘에 집중하기 위해 두 주 쉽니다** — 아래 표의 매핑을 두 주씩 밀었습니다.)
...
|    2     |    8주차    | 집계 함수                                       |   13    | Lv1~3    |
|    3     |    9주차    | NULL 처리 + GROUP BY 입문                       |   14    | Lv1~3    |
|    4     |   10주차    | GROUP BY 심화 + CASE                            |   12    | Lv2~4    |
|    5     |   11주차    | 문자열 · 날짜                                   |   14    | Lv1~3    |
|    6     |   12주차    | JOIN 기본                                       |   11    | Lv2~4    |
|    7     |   13주차    | 서브쿼리 + JOIN 심화                            |   12    | Lv2~5    |
|    8     |   14주차    | 종합 · 고난도                                   |   12    | Lv2~5    |
...
git switch main
git pull
git switch -c {깃허브 닉네임}/week-07
# 문제 풀고 커밋
git push -u origin {깃허브 닉네임}/week-07
